...
CREATE TABLE `cmf_createrecords` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='创建记录表';
...
CREATE TABLE `cmf_filename` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='数据库文件名';
...
insert into `cmf_route`(`id`,`list_order`,`status`,`type`,`full_url`,`url`) values('1','5000','1','2','portal/List/index?id=5','shop');
insert into `cmf_route`(`id`,`list_order`,`status`,`type`,`full_url`,`url`) values('2','4999','1','2','portal/Article/index?cid=5','shop/:id');
...
insert into `cmf_user`(`id`,`user_type`,`sex`,`birthday`,`last_login_time`,`score`,`coin`,`balance`,`create_time`,`user_status`,`user_login`,`user_pass`,`user_nickname`,`user_email`,`user_url`,`avatar`,`signature`,`last_login_ip`,`user_activation_key`,`mobile`,`more`) values('1','1','0','0','1565335006','4','4','0.00','1558344687','1','admin','###7c5bfcaddb516fbdba422b7d09f42595','admin','admin@qq.com','','','','127.0.0.1','','','');
